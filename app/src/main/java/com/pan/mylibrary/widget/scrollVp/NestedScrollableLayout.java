...
/**
 * Create by panchenhuan on 2019-09-27
 * walkwindc8@foxmail.com
 * Description:
 */
public class NestedScrollableLayout extends LinearLayout implements NestedScrollingParent {
    public NestedScrollableLayout(Context context) {
        this(context, null);
    }

    public NestedScrollableLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public NestedScrollableLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
